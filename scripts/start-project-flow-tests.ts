...
assert.match(flow, /保存并继续完善/, "final intake action should not imply that the project is already published");
assert.match(flow, /公开共创项目才会出现在项目市场/, "flow should explain when public marketplace visibility begins");
