...
export const NOTIFICATION_EVENTS = {
  ...
  PROJECT_APPLICATION_UPDATED: "PROJECT_APPLICATION_UPDATED",
...
function eventToStoredType(eventType: NotificationEventType): NotificationType | null {
  ...
  if (
    [
      ...
      NOTIFICATION_EVENTS.PROJECT_APPLICATION_RECEIVED,
      NOTIFICATION_EVENTS.PROJECT_APPLICATION_UPDATED,
