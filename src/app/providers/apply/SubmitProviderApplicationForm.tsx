...
export function SubmitProviderApplicationForm() {
  ...
  if (submitted) {
    return <div className="rounded-[8px] border border-black/8 bg-white p-6 text-sm leading-6 text-ink/65">申请已提交，平台审核后会联系你。</div>;
  }
  ...
  return (
    <form action={onSubmit} className="grid gap-3 rounded-[8px] border border-black/8 bg-white p-5 md:grid-cols-2">
      ...
      <textarea name="description" placeholder="服务能力简介" className="min-h-32 rounded-[6px] border border-black/10 px-3 py-3 text-sm md:col-span-2" />
