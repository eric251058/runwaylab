  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-8 md:px-8 md:py-12">
      <header className="overflow-hidden rounded-[8px] bg-white shadow-[0_16px_48px_rgba(16,16,16,0.08)]">
        <img src={challengeCoverUrl(challenge.coverUrl)} alt={challenge.title} className="aspect-[16/7] w-full object-cover" />
      ...
      <section className="mt-10">
        ...
        {challenge.incubationBatches.length ? (
          <div className="grid gap-4 md:grid-cols-2">
            {challenge.incubationBatches.map((batch) => (
          ...
          <div className="rounded-[8px] border border-black/8 bg-white p-6 text-sm text-ink/55">该挑战赛暂未关联公开孵化批次。</div>
        )}
      </section>
    </div>
  );
